...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='timeslot',
            constraint=models.CheckConstraint(check=models.Q(('start__leq', models.F('end'))), name='timeslot_start_leq_end'),
        ),
        migrations.AddConstraint(
            model_name='reservation',
            constraint=models.CheckConstraint(check=models.Q(('start__leq', models.F('end'))), name='reservation_start_leq_end'),
        ),
    ]
